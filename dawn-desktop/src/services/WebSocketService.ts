...
class WebSocketService {
  ...
  connect() {
    console.log('🔌 Connecting to DAWN WebSocket server on port 8001/ws...');
    try {
      this.ws = new WebSocket(this.url);
      
      this.ws.onopen = () => {
        console.log('✅ Connected to DAWN consciousness engine on port 8001/ws!');
      ...
      this.ws.onclose = () => {
        console.log('WebSocket disconnected from port 8001/ws');
