...
Optional GUI monitoring interface
"""
...
def start_gui_monitoring(dawn_system=None):
    ...
    try:
        ...
        if dawn_system and hasattr(dawn_system, 'tick_engine'):
        ...
        logger.info("💡 To enable GUI: ensure tkinter is installed")
        return None
...
async def main():
    ...
    parser.add_argument(
        '--gui',
        action='store_true',
        help='Enable GUI monitoring interface'
    )
    parser.add_argument(
        '--debug',
        action='store_true',
