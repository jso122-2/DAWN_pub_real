...
class SCUPZoneAnimator:
    def __init__(self, data_source="stdin", buffer_size=100, save_frames=False, output_dir="./visual_output"):
...
def main():
    ...
    animator = SCUPZoneAnimator(data_source=args.source, buffer_size=args.buffer, save_frames=args.save, output_dir=args.output_dir)
