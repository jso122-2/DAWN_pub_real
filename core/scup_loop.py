...
try:
    ...
    try:
        from pulse.pulse_heat import pulse_heat
    except ImportError:
        pulse_heat = None
...
try:
    ...
    def current_tick(): return 0
    def tick_subscribe(callback): pass
...
try:
    ...
    try:
        ...
        def owl_log(msg, level="info"): print(f"[SCUP-{level.upper()}] {msg}")
