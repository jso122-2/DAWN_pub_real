...
try:
    from reflex.meta_reflex import MetaReflex
    META_REFLEX_AVAILABLE = True
except ImportError:
    META_REFLEX_AVAILABLE = False
    class MetaReflex:
        def __init__(self):
            pass
        def evaluate_system_state(self, *args, **kwargs):
            return []
        def generate_reflex_commands(self, *args, **kwargs):
            return []
        def log_intervention(self, *args, **kwargs):
            pass
        def execute_reflex_commands(self, *args, **kwargs):
            pass
...
try:
    ...
    SIGIL_MEMORY_RING_AVAILABLE = True
except ImportError:
    SIGIL_MEMORY_RING_AVAILABLE = False
